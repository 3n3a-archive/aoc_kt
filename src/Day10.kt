fun Day10() {
    ...
    fun part2(input: List<String>): MutableList<MutableList<String>> {
        // reset
        sumOfSignalStrengths = 0
    ...
    val correctAnswerPart2Test = mutableListOf<List<String>>(
        mutableListOf("#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", "#", "#", ".", ".", ""),
        mutableListOf("#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ".", ".", "#", "#", "#", ".", ""),
        mutableListOf("#", "#", "#", "#", ".", ".", ".", ".", "#", "#", "#", "#", ".", ".", ".", ".", "#", "#", "#", "#", ".", ".", ".", ".", "#", "#", "#", "#", ".", ".", ".", ".", "#", "#", "#", "#", ".", ".", ".", ".", ""),
        mutableListOf("#", "#", "#", "#", "#", ".", ".", ".", ".", ".", "#", "#", "#", "#", "#", ".", ".", ".", ".", ".", "#", "#", "#", "#", "#", ".", ".", ".", ".", ".", "#", "#", "#", "#", "#", ".", ".", ".", ".", ".", ""),
    ...
    check(part2(testInput) == correctAnswerPart2Test)
    ...
    println("\n############### Part 2 ################")
    val correctAnswerPart2 = mutableListOf<List<String>>(
        mutableListOf("#", "#", "#", "#", ".", "#", "#", "#", ".", ".", ".", "#", "#", ".", ".", "#", "#", "#", ".", ".", "#", ".", ".", ".", ".", "#", "#", "#", "#", ".", "#", "#", "#", "#", ".", "#", ".", ".", "#", ".", ""),
        mutableListOf(".", ".", ".", "#", ".", "#", ".", ".", "#", ".", "#", ".", ".", "#", ".", "#", ".", ".", "#", ".", "#", ".", ".", ".", ".", "#", ".", ".", ".", ".", ".", ".", ".", "#", ".", "#", ".", ".", "#", ".", ""),
        mutableListOf(".", ".", "#", ".", ".", "#", ".", ".", "#", ".", "#", ".", ".", "#", ".", "#", ".", ".", "#", ".", "#", ".", ".", ".", ".", "#", "#", "#", ".", ".", ".", ".", "#", ".", ".", "#", ".", ".", "#", ".", ""),
        mutableListOf(".", "#", ".", ".", ".", "#", "#", "#", ".", ".", "#", "#", "#", "#", ".", "#", "#", "#", ".", ".", "#", ".", ".", ".", ".", "#", ".", ".", ".", ".", ".", "#", ".", ".", ".", "#", ".", ".", "#", ".", ""),
    ...
    println("2: " + (part2Result == correctAnswerPart2))
}
